 ...
 * @param {string} state - The state of the modal (create or update).
    ...
    if (createNewPostModalElement) {
        ...
        if (form) {
            ...
            if (state === "update" && post) {
                ...
                form.querySelector("#postButton").textContent = "Save Changes";
            } else {
                form.querySelector("#postButton").textContent = "Post";
            }
